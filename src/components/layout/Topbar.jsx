    ...
    return (
        <header className="h-14 bg-white border-b border-slate-200 flex items-center justify-between px-4 shrink-0 shadow-sm z-30">
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-base font-bold text-slate-800 hidden sm:block">NexERP</h1>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2.5 cursor-pointer hover:bg-slate-50 p-1.5 rounded-md transition-colors">
                    <div className="text-right hidden sm:block">
                        <div className="text-[13px] font-bold text-slate-800 leading-tight">Juan Pérez</div>
                        <div className="text-[10px] text-slate-500 font-medium">CONSTRUCTORA S.A.</div>
                    </div>
